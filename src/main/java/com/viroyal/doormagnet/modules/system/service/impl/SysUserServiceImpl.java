...
import com.viroyal.doormagnet.modules.system.mapper.SysPermissionMapper;
...
public class SysUserServiceImpl implements ISysUserService {
    ...
    public Result<?> changePassword(SysUser sysUser) {
        ...
        this.userMapper.updateByPrimaryKey(sysUser);
	...
	public boolean deleteBatchUsers(String userIds) {
		//1.删除用户
		this.userMapper.deleteByPrimaryKeys(Arrays.asList(userIds.split(",")));
		return false;
	}
...
//			}
		...
		logger.info("-------通过数据库读取用户拥有的权限Perms------username： "+ username+",Perms size: "+ (permissionSet==null?0:permissionSet.size()) );
